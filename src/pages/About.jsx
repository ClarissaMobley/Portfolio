            ...
            <div className='container mx-auto px-8 md:px-16 lg:px-24'>
                <div className='flex flex-col md:flex-row items-center md:space-x-12 animate-fadeIn'>
                    ...
                    <div className='flex-1'>
                        <h2 className='text-6xl text-[#e4b3b3] font-bold text-start mb-8'>About Me</h2>
                        <h3 className='text-2xl text-white font-bold'>I'm Clarissa Mobley, a Full-Stack Developer based in Atlanta.</h3>
                        <p className='text-md mb-4'> I have a solid foundation in HTML, CSS, and JavaScript. Before transitioning into tech, 
                        ...
                        <p className='text-md mb-4'> In my journey to become a developer, I have learned to work with a variety of technologies, 
